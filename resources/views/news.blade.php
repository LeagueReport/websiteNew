...
<div class="container" style="padding-left: 0; padding-right: 0;"> 
  <!-- Navigation: Creates the links to the other pages on our site to make navigating easy. 
  The links to the HOME,ITEM SET BUILD, NEWS, and LOGIN pages are all made here-->
  <header>
  ...
  <!--News Section. This is where entire code lies that creates our news page's content. -->
...
<!-- start sw-rss-feed code. Sets up the look and feel of the RSS news feed we have on the news page. --> 
...
<!--This is where I add the links to other popular League of Legends News websites/blogs. There are 4 different links: Riot Official news page, TheRiftHerald, Surrender@20, and the reddit league of legends subreddit.-->
...
<!--This is where I add the youtube player to the news page. I create an iFrame then make requests to the youtube api and data bind the data I get back to the iFrame. -->
<script type="text/javascript">
